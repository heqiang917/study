...
<head>
	...
	<link href="/dist/static/css/project-files.css?{{webpack.hash}}" rel="stylesheet" type="text/css"/>
	<@init/>
</head>
<body>
	...
	<script type="text/javascript" src="/dist/static/js/vendor.js?{{webpack.hash}}"></script>
  	...
  	<script type="text/javascript" src="/dist/static/js/project-files.js?{{webpack.hash}}"></script>
</body>
</html>
</#escape>
</@compress>
