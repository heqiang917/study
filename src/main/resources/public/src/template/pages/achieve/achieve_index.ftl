...
<head>
	...
	<link href="/dist/static/css/achieve-index.css?{{webpack.hash}}" rel="stylesheet" type="text/css"/>
	<@init/>
</head>
<body>
	...
	<script type="text/javascript" src="/dist/static/js/vendor.js?{{webpack.hash}}"></script>
  	...
  	<script type="text/javascript" src="/dist/static/js/achieve-index.js?{{webpack.hash}}"></script>
</body>
</html>
</#escape>
</@compress>
